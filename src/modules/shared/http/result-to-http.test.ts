...
import { createResultToHttpMapper, type ResultHttpMapping } from '@/modules/shared/http/result-to-http';
import { HTTP_CREATED, HTTP_INTERNAL_SERVER_ERROR, HTTP_UNAUTHORIZED } from '@/modules/shared/http/status-code';
